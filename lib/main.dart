...
import 'package:minha_loja/views/product_form_screen.dart';
import 'package:minha_loja/views/products_screen.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          AppRoutes.PRODUCTS_SCREEN: (ctx) => ProductsScreen(),
